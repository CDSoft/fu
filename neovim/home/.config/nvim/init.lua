                ...
                Lua = {
                    ...
                    workspace = {
                        ...
                        library = {
                            ...
                            '%(FU_PATH)/luax/libluax/debug',
                            '%(FU_PATH)/luax/libluax/F',
                            '%(FU_PATH)/luax/libluax/fs',
                            '%(FU_PATH)/luax/libluax/imath',
                            '%(FU_PATH)/luax/libluax/import',
                            '%(FU_PATH)/luax/libluax/lar',
                            '%(FU_PATH)/luax/libluax/linenoise',
                            '%(FU_PATH)/luax/libluax/lz4',
                            '%(FU_PATH)/luax/libluax/lzip',
                            '%(FU_PATH)/luax/libluax/mathx',
                            '%(FU_PATH)/luax/libluax/package',
                            '%(FU_PATH)/luax/libluax/ps',
                            '%(FU_PATH)/luax/libluax/qmath',
                            '%(FU_PATH)/luax/libluax/sh',
                            '%(FU_PATH)/luax/libluax/sys',
                            '%(FU_PATH)/luax/libluax/tar',
                            '%(FU_PATH)/luax/libluax/term',
                            '%(FU_PATH)/luax/libluax/wget',
                            '%(FU_PATH)/luax/ext/lua/argparse',
                            '%(FU_PATH)/luax/ext/lua/cbor',
                            '%(FU_PATH)/luax/ext/lua/json',
                            '%(FU_PATH)/luax/ext/lua/serpent',
                        },
                    },
